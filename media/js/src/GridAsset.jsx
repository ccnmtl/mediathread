...
export default class GridAsset extends React.Component {
    ...
    onSelectedAnnotationUpdate(annotation) {
        ...
        //console.log(this.props.asset.annotations[annotation]);
        const feature = new Feature({
            geometry: new Polygon(
                this.props.asset.annotations[annotation]
        ...
        this.map.addLayer(this.state.annotationLayer);
