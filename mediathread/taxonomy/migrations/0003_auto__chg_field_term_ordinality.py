...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Term.ordinality'
        db.alter_column('taxonomy_term', 'ordinality', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Term.ordinality'
        db.alter_column('taxonomy_term', 'ordinality', self.gf('django.db.models.fields.IntegerField')(default=0))
