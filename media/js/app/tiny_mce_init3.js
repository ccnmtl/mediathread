...
var tiny_mce_settings = {
        ...
        /* CUSTOM CCNMTL: added 'citation' and 'editorwindow'
         * --see bottom for explicit loading from a location */
        plugins: 'searchreplace,table,-citation,inlinepopups,' +
                 '-editorwindow,xhtmlxtras,paste,wordcount',
        /* CUSTOM CCNMTL: visual is set to false, so anchor tags don't
         * get messed up.  This is probably a bug
           to be reported to tinyMCE */
        visual: false,
        theme_advanced_styles: 'Even=even;Odd=odd;Highlight=visualHighlight;' +
            'Discreet=discreet;Image Right=imageRight;Image ' +
            'Inline=imageInline;Image Left=imageLeft;Sidebar=contentSideBar',
        ...
        theme_advanced_buttons1: 'bold, italic, underline, spacer, bullist, ' +
            'numlist, spacer, outdent, indent, spacer, undo, redo, spacer, ' +
            'link, unlink, image, spacer, code, pasteword',
        ...
        valid_elements: '' +
            ...
            'button[accesskey|class|disabled<disabled|id|name|tabindex' +
            '|title|type|value],' +
            'caption,' +
            'center[class|id|title],' +
            'cite[class|id|title],' +
            'code[class|id|title],' +
            'col[off|class|id|span|title|valign' +
            '<baseline?bottom?middle?top|width],' +
            'colgroup[off|class|id|span|title|valign<baseline?' +
            'bottom?middle?top|width],' +
            'dd[class|id|title],' +
            ...
            'form[accept|accept-charset|action|class|enctype|id|' +
            'method<get?post|name|title|target],' +
            'h1[class|id|title],' +
            'h2[class|id|title],' +
            'h3[class|id|title],' +
            'h4[class|id|title],' +
            'h5[class|id|title],' +
            'h6[class|id|title],' +
            'hr[align<center?right|class|id|noshade<noshade|' +
            'size|title|width],' +
            'iframe[align<bottom?left?middle?right?top|class|frameborder' +
            '|height|id|longdesc|marginheight|marginwidth|name|scrolling' +
            '<auto?no?yes|src|title|width],' +
            'img[alt|border|class|height|hspace|id|longdesc|' +
            'name|src|title|width],' +
            'input[accept|accesskey|alt|checked<checked|class|disabled' +
            '<disabled|id|maxlength|name|readonly<readonly|size|src|tabindex' +
            '|title|type<button?checkbox?file?hidden?image?password?radio' +
            '?reset?submit?text|value|onclick],' +
            ...
            'option[class|disabled<disabled|id|label|selected<selected|' +
            'title|value],' +
            'p[align<center?right?justify|class|id|style|title],' +
            'param[id|name|type|value|valuetype<DATA?OBJECT?REF],' +
            'pre/listing/plaintext/xmp[align<center?right?justify|class' +
            '|id|title|width],' +
            'q[cite|class|id|title],' +
            's[class|id|title],' +
            'samp[class|id|title],' +
            'select[class|disabled<disabled|id|multiple<multiple|name|' +
            'size|tabindex|title],' +
            ...
            'textarea[accesskey|class|cols|disabled<disabled|id|name|' +
            'readonly<readonly|rows|tabindex|title],' +
