...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('assetmgr_source', 'url', self.gf('django.db.models.fields.CharField')(max_length=4096))


    def backwards(self, orm):
        
        # Changing field 'Source.url'
        db.alter_column('assetmgr_source', 'url', self.gf('django.db.models.fields.CharField')(max_length=1024))
