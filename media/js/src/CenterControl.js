...
export default class CenterControl extends Control {
    constructor(opt_options={}) {
        ...
        button.addEventListener(
            'click', this.handleCenter.bind(this, opt_options.extent), false);
