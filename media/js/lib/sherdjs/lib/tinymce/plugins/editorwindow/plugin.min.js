...
(function() {
    var EventUtils = tinymce.dom.EventUtils, DOM = tinymce.DOM, is = tinymce.is;
    ...
    tinymce.create('tinymce.plugins.EditorWindow', {
        ...
        _openWindow: function(ed,current_elt,parent) {
            ...
            EventUtils.bind(id+'_close', 'mousedown', function(evt){
        ...
        _closeWindow: function(ed,current_elt) {
            ...
            this.opened = false;
            if (this.win) {
                EventUtils.unbind(window,'keydown',this._closeOnEscape,this);
                DOM.remove(this.win);
                delete this.win;
            }
        },
