Feature: Collection View    
    ...
    Scenario Outline: collection.feature 2. Collection - Viewing Items & Selections
        ...
        Then the owner is "<instructor_one_relationship>" in the Collection column
        Then the Collection panel has a "MAAP Award Reception" item
        And the "MAAP Award Reception" item has <total_selections> selections, 1 by me
        
        And I can filter by "instructor_one" in the Collection column
        And I can filter by "instructor_one_selection" in the Collection column
        
        # Student One
        When I select "Student One" as the owner in the Collection column
        Then the owner is "<student_one_relationship>" in the Collection column
        Then the Collection panel has a "MAAP Award Reception" item
        And the "MAAP Award Reception" item has <total_selections> selections, 1 by me
        
        And I can filter by "student_one_selection" in the Collection column
        And I can filter by "student_one_item" in the Collection column
        
        # All Class Members
        When I select "All Class Members" as the owner in the Collection column
        ...
        And I can filter by "student_one_selection" in the Collection column
        And I can filter by "student_one_item" in the Collection column
        And I can filter by "student_two_selection" in the Collection column
        And I can filter by "student_two_item" in the Collection column
   ...
   Scenario: collection.feature 3. Collection - Limited Selection Visibility 
        ...
        # Instructor One
        When I select "Instructor One" as the owner in the Collection column
        ...
        # Student Two
        When I select "Student Two" as the owner in the Collection column
        Then the owner is "Student Two" in the Collection column
        Then the Collection panel has a "MAAP Award Reception" item
        And the "MAAP Award Reception" item has 2 selections, 1 by me
        And I cannot filter by "student_two_selection" in the Collection column
        And I cannot filter by "student_two_item" in the Collection column
    ...
    Scenario: collection.feature 4. Collection - Filter by tag
        ...
        When I filter by "flickr" in the Collection column
        Then the Collection panel has a "MAAP Award Reception" item
        And the Collection panel has a "The Armory - Home to CCNMTL'S CUMC ..." item
        And the Collection panel has no "Mediathread: Introduction" item
        
        When I clear the filter in the Collection column
        Then the Collection panel has a "MAAP Award Reception" item
        And the Collection panel has a "The Armory - Home to CCNMTL'S CUMC ..." item
        And the Collection panel has a "Mediathread: Introduction" item
        
        When I filter by "video" in the Collection column
