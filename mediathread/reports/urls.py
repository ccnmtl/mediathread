...
urlpatterns = patterns(
    ...
    url(r'^class_assignments/$', 'mediathread.reports.views.class_assignments',
    ...
    url(r'^class_summary/$', 'mediathread.reports.views.class_summary',
        name='class-summary'),
    url(r'^class_summary/graph.json$', ClassSummaryGraphView.as_view(),
        name='class-summary-graph'),

    url(r'^class_activity/$', 'mediathread.reports.views.class_activity',
        name='class-activity'),
