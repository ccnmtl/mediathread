...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.due_date'
        db.add_column('projects_project', 'due_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Project.due_date'
        db.delete_column('projects_project', 'due_date')
