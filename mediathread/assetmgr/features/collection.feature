Feature: Collection View    
    ...
    Scenario: collection.feature 2. Collection - Viewing Items & Selections
        ...
        Then the Collection panel has a "The Armory - Home to CCNMTL'S CUMC &hellip;" item
   ...
   Scenario: collection.feature 6. Collection - Limited Selection Visibility 
        ...
        Then the Collection panel has a "The Armory - Home to CCNMTL'S CUMC &hellip;" item
        And the "The Armory - Home to CCNMTL'S CUMC &hellip;" item has no notes
        And the "The Armory - Home to CCNMTL'S CUMC &hellip;" item has no tags
        And the "The Armory - Home to CCNMTL'S CUMC &hellip;" item has no selections
    ...
    Scenario: collection.feature 7. Collection - Filter by tag
        ...
        Then the Collection panel has a "MAAP Award Reception" item
        And the Collection panel has a "The Armory - Home to CCNMTL'S CUMC &hellip;" item
        ...
        And the Collection panel has no "The Armory - Home to CCNMTL'S CUMC &hellip;" item
        And the Collection panel has a "Mediathread: Introduction" item
