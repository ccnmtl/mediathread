...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectVersion.due_date'
        db.add_column('projects_projectversion', 'due_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)        


    def backwards(self, orm):

        # Deleting field 'ProjectVersion.due_date'
        db.delete_column('projects_projectversion', 'due_date')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'course': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'project_set'", 'to': "orm['courseaffils.Course']"}),
